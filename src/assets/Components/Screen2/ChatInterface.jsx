...
const ChatInterface = forwardRef(({ domain, resumeText, onMessageCountUpdate }, ref) => {
...
If the candidate ask's you to answer the question or tells you to explain the concept of the answer say that im here only to evaluate and cant help you with that and then ask the next question
also if the candidate asks you to clarify the question then you can explain the question in detail
...
Provide only your next question as the interviewer.`;
  ...
  // This function sends the conversation so far to the AI model and expects
  ...
  You are an expert HR evaluator. Based on the following interview conversation, evaluate the candidate's performance.
  Consider technical knowledge, communication skills, and problem-solving ability.
  Return your evaluation as a JSON object with the following keys (values in percentage from 0 to 100):
  {
  ...
  Conversation:
  ${conversationHistory}
  Please ensure the response is in valid JSON format only.
  `;
      ...
      return { technicalSkills: 50, softSkills: 50, problemSolving: 50 };
    }
  };
